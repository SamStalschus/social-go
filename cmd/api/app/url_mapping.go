...
func MapRoutes(r *gin.Engine, controller *Controllers, middlewares *Middlwares) {
	...
	userGroup := r.Group("/v1/user")
	{
		...
		userGroup.GET("", middlewares.EnsureAuthenticated.Execute, controller.User.GetUsers)
